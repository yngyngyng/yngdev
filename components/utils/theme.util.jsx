    ...
    if (canvasEle) {
      ...
      class MiniGl {
        constructor(e, n, t, i = !1) {
          ...
          n && t && this.setSize(n, t),
            ...
            (s.debug =
              i && o
                ? function (e) {
                    const n = new Date()
                    n - s.lastDebugMsg > 1e3, (s.lastDebugMsg = n)
                  }
                : () => {}),
                ...
                value: class {
                  constructor(e, n, t = {}) {
                    function i(e, n) {
                      ...
                      return (
                        ...
                        r.getShaderParameter(t, r.COMPILE_STATUS) ||
                          console.error(r.getShaderInfoLog(t)),
                        s.debug('Material.compileShaderSource', { source: n }),
                        t
                      )
                    }
                    function o(e, n) {
                    ...
                    ;(a.vertexSource = `\n              ${l}\n              attribute vec4 position;\n              attribute vec2 uv;\n              attribute vec2 uvNorm;\n              ${o(s.commonUniforms, 'vertex')}\n              ${o(t, 'vertex')}\n              ${e}\n            `),
                      ...
                      (a.fragmentShader = i(r.FRAGMENT_SHADER, a.Source)),
                      (a.program = r.createProgram()),
                      r.attachShader(a.program, a.vertexShader),
                      r.attachShader(a.program, a.fragmentShader),
                      r.linkProgram(a.program),
                      r.getProgramParameter(a.program, r.LINK_STATUS) ||
                        console.error(r.getProgramInfoLog(a.program)),
                      r.useProgram(a.program),
                      a.attachUniforms(void 0, s.commonUniforms),
                  ...
                  attachUniforms(e, n) {
                    ...
                    void 0 === e
                      ...
                      : 'array' == n.type
                        ...
                        : 'struct' == n.type
                          ? Object.entries(n.value).forEach(([n, i]) =>
              ...
              PlaneGeometry: {
                ...
                value: class {
                  ...
                  setTopology(e = 1, n = 1) {
                    ...
                    ;(t.xSegCount = e),
                      (t.ySegCount = n),
                      (t.vertexCount = (t.xSegCount + 1) * (t.ySegCount + 1)),
                      (t.quadCount = t.xSegCount * t.ySegCount * 2),
                      (t.attributes.uv.values = new Float32Array(
                        2 * t.vertexCount
                      )),
                      (t.attributes.uvNorm.values = new Float32Array(
                        2 * t.vertexCount
                      )),
                      (t.attributes.index.values = new Uint16Array(
                        3 * t.quadCount
                      ))
                    for (let e = 0; e <= t.ySegCount; e++)
                      for (let n = 0; n <= t.xSegCount; n++) {
                        ...
                        if (
                          ((t.attributes.uv.values[2 * i] = n / t.xSegCount),
                          (t.attributes.uv.values[2 * i + 1] =
                            1 - e / t.ySegCount),
                          (t.attributes.uvNorm.values[2 * i] =
                            (n / t.xSegCount) * 2 - 1),
                          (t.attributes.uvNorm.values[2 * i + 1] =
                            1 - (e / t.ySegCount) * 2),
                          n < t.xSegCount && e < t.ySegCount)
                        ) {
                          const s = e * t.xSegCount + n
                          ;(t.attributes.index.values[6 * s] = i),
                            (t.attributes.index.values[6 * s + 1] =
                              i + 1 + t.xSegCount),
                            (t.attributes.index.values[6 * s + 2] = i + 1),
                            (t.attributes.index.values[6 * s + 3] = i + 1),
                            (t.attributes.index.values[6 * s + 4] =
                              i + 1 + t.xSegCount),
                            (t.attributes.index.values[6 * s + 5] =
                              i + 2 + t.xSegCount)
                        }
                      }
                ...
                value: class {
                  constructor(e, n) {
                    ...
                    ;(t.geometry = e),
                      ...
                      Object.entries(t.geometry.attributes).forEach(
                        ([e, n]) => {
                  ...
                  draw() {
                    r.useProgram(this.material.program),
                      this.material.uniformInstances.forEach(
                        ({ uniform: e, location: n }) => e.update(n)
                      ),
                      this.attributeInstances.forEach(
                        ({ attribute: e, location: n }) => e.use(n)
                      ),
                      r.drawElements(
          ...
          s.commonUniforms = {
            projectionMatrix: new s.Uniform({ type: 'mat4', value: a }),
            modelViewMatrix: new s.Uniform({ type: 'mat4', value: a }),
            resolution: new s.Uniform({ type: 'vec2', value: [1, 1] }),
        ...
        constructor(...n) {
          e(this, 'el', void 0),
            ...
            e(
              ...
              'initGradient',
              (e) => (
                (this.el = document.querySelector(e)), this.connect(), this
              )
            )
        }
        async connect() {
